...
public class DreamworldDialogueCanvas : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        DreamworldDialogueController dialogueController = DreamworldDialogueController.DreamworldUI;
    ...
    {
        DreamworldDialogueController dialogueController = DreamworldDialogueController.DreamworldUI;
        continueButton.onClick.AddListener(() => dialogueController.PlayDialogue(true));
        previousButton.onClick.AddListener(() => dialogueController.PlayDialogue(false));
        AutoplayOnButton.onClick.AddListener(() => dialogueController.ToggleAutoplay(true));
        AutoplayOffButton.onClick.AddListener(() => dialogueController.ToggleAutoplay(false));
        skipButton.onClick.AddListener(() => StartCoroutine(dialogueController.SkipDialogue()));
        FinishButton.onClick.AddListener(() => dialogueController.PlayDialogue(true));
