...
public static class Settings
{
    ...
    public static BoolSetting MetronomeBlink = new BoolSetting("Metronome Blink Enabled", true);
    ...
    public static FloatSetting MusicVolume = new FloatSetting("Music Volume", 1f, 0.0001f, 1f);
    public static FloatSetting SoundVolume = new FloatSetting("Sound Volume", 1f, 0.0001f, 1f);
